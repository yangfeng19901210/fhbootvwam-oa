                            ...
                            <div class="row">
								...
								<div style="width: 100%;">
									...
									<table width="100%" border="1" cellpadding="1" cellspacing="1" align="center" style="border:0px solid #DFDFDF;border-collapse:collapse;margin-top: -10px;">
										<tr height="34">
											<td style="text-align: right;padding-top: 5px;" colspan="8">
												<button class="btn btn-success btn-sm" v-on:click="save">保存</button>
												<button class="btn btn-warning btn-sm" onclick="top.Dialog.close();">取消</button>
											</td>
										</tr>
										<tr height="34">
											<td style="text-align: center;width:79px;">上级</td>
											<td style="padding-left: 10px;">{{'0' == PARENT_ID ?'(无) 此项为顶级':pds.NAME}}</td>
										</tr>
										<tr height="34">
											<td style="text-align: center;width:79px;">名称</td>
											<td><input type="text" ref="NAME" id="NAME" v-model="pd.NAME"  placeholder="这里输入名称" title="名称" style="width: 98%;border: 0;padding-left: 5px;"></td>
										</tr>
								...
								<#if var[3] == "是">
									<#if var[1] == 'Date'>
										<tr height="34">
											...
											<td><input type="text" class="form-control date" ref="${var[0] }" id="${var[0] }" maxlength="32" placeholder="这里输入${var[2] }" title="${var[2] }" style="height: 34px;width: 100%;border: 0;padding-left: 5px;" readonly="readonly"></td>
										</tr>
									<#elseif var[1] == 'Integer'>
										<tr height="34">
											<td style="text-align: center;width:79px;">${var[2] }</td>
											<td><input type="number" ref="${var[0] }" id="${var[0] }" v-model="pd.${var[0]}" maxlength="${var[5] }" placeholder="这里输入${var[2] }" title="${var[2] }" style="width: 98%;border: 0;padding-left: 5px;"></td>
										</tr>
									<#elseif var[1] == 'Double'>
										<tr height="34">
											<td style="text-align: center;width:79px;">${var[2] }</td>
									...
									<#if var[7] != 'null'>
										<tr height="34">
											<td style="text-align: center;width:79px;">${var[2] }</td>
											<td>
												<select ref="${var[0]}" id="${var[0]}" v-model="${var[0]}" data-placeholder="${var[2]}" title="${var[2]}" style="width:96%;height:30px;padding-left:5px;border: 0px solid #CED4DA;transparent;appearance:none;-moz-appearance:none;-webkit-appearance:none;"></select>
											</td>
										</tr>
									<#else>
										<tr height="34">
											<td style="text-align: center;width:79px;">${var[2] }</td>
											<td><input type="text" ref="${var[0] }" id="${var[0] }" v-model="pd.${var[0]}" maxlength="${var[5] }" placeholder="这里输入${var[2] }" title="${var[2] }" style="width: 98%;border: 0;padding-left: 5px;"></td>
										</tr>
									</#if>
									</#if>
								</#if>
