                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
										...
										<!-- 检索  -->
										<div style="padding-left: 23px;padding-top: 15px;">
										<table>
											<tr>
												<td>
												...
												<table style="width:100%;margin-top:15px;">
													<tr>
														<td style="vertical-align:top;">
															<button v-show="add" class="btn btn-primary btn-sm" v-on:click="goAdd">新增</button>
														</td>
        	...
        	$.ajax({
        		...
        		success: function(data){
        		 if("success" == data.result){
					...
					vm.cha = data.${objectNameLower}fhadmincha;		//查看权限
