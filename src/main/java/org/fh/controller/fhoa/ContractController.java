...
public class ContractController extends BaseController {
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("FIRSTPARTY"));	    //2
			vpd.put("var3", varOList.get(i).getString("SECONDPARTY"));	    //3
			vpd.put("var4", varOList.get(i).getString("STIME"));	    //4
			vpd.put("var5", varOList.get(i).getString("ETIME"));	    //5
